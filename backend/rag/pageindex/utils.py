...
async def generate_node_summary(node, model=None):
    prompt = f"""You are given a part of a document, your task is to generate a concise description of the partial document about what are main points covered. Directly return the description that starts with "This section..." or "此章节...". Do not include any other text.
